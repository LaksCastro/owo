...
class _MyHomePageState extends State<MyHomePage> {
  ...
  static const MethodChannel downloadPathChannel = OptionalMethodChannel(
    'samples.flutter.io/download_path',
  );
        ...
        builder: (context) => _isLoading
            ...
            : _permissionReady
                ? GestureDetector(
                    onTap: () async {
                      try {
                        final result = await downloadPathChannel
                            .invokeMethod('getDownloadPath');
...
//
// if (widget.platform == TargetPlatform.android) {
//   downloadPath = await downloadPathChannel.invokeMethod('getDownloadPath');
//
//   return '';
// }
//
// final directory = widget.platform == TargetPlatform.android
//     ? File(downloadPath) //await getExternalStorageDirectory()
